...
const shop = new DeliveryShop(100); // create shop with deliveryFee
shop.addItem(new Product(1000)); // add product with price to the shop
...
console.log(shop.getPrice()); // return total amount
